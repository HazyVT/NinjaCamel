...
public class StraightShurikenScript : MonoBehaviour
{
        public float speed;
    public int damage;
        ...
        if (!ExperienceManager.isLeveling)
        {
            switch (which)
            {
                ...
                case 1:
                    ...
                    float _ypos2 = Utilities.Approach(transform.position.y, transform.position.y + 3 * Time.deltaTime, speed * Time.deltaTime);
                ...
                case 2:
                    ...
                    float _ypos3 = Utilities.Approach(transform.position.y, transform.position.y - 3 * Time.deltaTime, speed * Time.deltaTime);
                ...
                case 3:
                    ...
                    float _ypos4 = Utilities.Approach(transform.position.y, transform.position.y + 10 * Time.deltaTime, speed * Time.deltaTime);
                ...
                case 4:
                    ...
                    float _ypos5 = Utilities.Approach(transform.position.y, transform.position.y - 10 * Time.deltaTime, speed * Time.deltaTime);
